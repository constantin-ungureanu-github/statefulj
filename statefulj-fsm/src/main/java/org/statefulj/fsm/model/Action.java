...
public interface Action<T> {
     ...
     *            The ocurring Event
     * @param args
     *            A set of optional arguments passed into the onEvent method of the {@link org.stateful.fsm.FSM}
     * @throws RetryException
     *             thrown when the event must be retried due to Stale state or some other error condition
     */
