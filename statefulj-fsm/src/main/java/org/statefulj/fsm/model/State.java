...
public interface State<T> {
    ...
    /**
     * Whether this is a Blocking State. If Blocking, event will not processed unless there is an explicit Transition for the event. If blocked, the FSM will retry the event until the FSM transitions
     ...
     * 
     * @param isBlocking
     *            if true, then this is a blocking State
     */
     ...
     * 
     * @param event
     *            Remove the transition for this Event
     */
    public void removeTransition(String event);

    /**
     * Add a {@link org.statefulj.fsm.model.Transtion}
     * 
     * @param event
     *            The event to add the {@link org.statefulj.fsm.model.Transtion}
     * @param transition
     *            The {@link org.statefulj.fsm.model.Transtion}
     */
     ...
     *            The next State
     * @param action
     *            The resulting {@link org.statefulj.fsm.model.Action}
     */
