...
public interface Persister<T> {
    ...
    /**
     * Set the current state to the next state. Will serialize access to the persistence and ensure that expected current state is indeed the current state. If not, will throw a StaleStateException
     * 
     * @param stateful
     *            StatefulEntity
     * @param current
     *            Expected current State of the Stateful Entity
     * @param next
     *            The value of the updated State
     * @throws StaleStateException
     *             thrown if the state value of the Stateful Entity is not equal to the passed in current value
     */
