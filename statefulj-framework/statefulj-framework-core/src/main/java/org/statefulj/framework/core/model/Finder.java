...
/**
 * Finder is responsible to locating and retrieving the Stateful Entity. There are two methods which can be invoked - one without an Id for the Stateful Entity and one with the Id of the Stateful
 * Entity.
 * 
 * @author Andrew Hall
 *
 * @param <T>
 *            Type of the Stateful Entity
 * @param <CT>
...
public interface Finder<T, CT> {
     ...
     * 
     * @param clazz
     *            The Class of the Stateful Event
     * @param event
     *            The Event
     * @param context
     *            The Request Context
